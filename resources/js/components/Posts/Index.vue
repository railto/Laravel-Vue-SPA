...
export default {
    setup() {
        ...
        const updateOrdering = (column) => {
            ...
            getPosts(1, search_category.value, search_id.value, search_title.value, search_content.value, orderColumn.value, orderDirection.value, search_global.value)
        }
        ...
        watch(search_id, (current, previous) => {
            getPosts(1, search_category, current, search_title.value, search_content.value, search_global.value);
        });
